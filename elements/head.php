<!--used for temp pages and for development-->
...
$css_arr = array(
				...
				// Theme Files From Evolution Theme (Zeeshan Hasan) 
				...
				base_url().$_SESSION['TEMPLATE_USED'] . "css/styles_prev.css",				// Theme - stylesheet
...
//				base_url().ADMIN_ASSET_DIR . "js/jquery/custom_jquery.js",
