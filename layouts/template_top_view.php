...
<div style="z-index: 1000; border: medium none; margin: auto; top: 0; left: 0; padding: 0pt; width: 100%; height: 100%; background-color: #1E1E1E; cursor: wait; position: fixed;" class="blockUI blockOverlay"></div>
...
<!--End Head-->
<body id="body">
	<?$this->load->view('admin/elements/header_view');?>
